document.addEventListener("DOMContentLoaded", function () {
    const texts = {
        es: {
            ...
            padel_opcion: "Pádel",
            seleccion_nivel: "¿En qué nivel te encuentras?",
        ...
        en: {
            ...
            reservanav: "BOOK YOUR CLASS",
            nombre: "JELZI SPORTS CENTER",
            eslogan: "GET READY TO FEEL BETTER!",
            general: "GENERAL INFORMATION",
            descripcion_general: "The Jelzyi Sports Center has 6000m² of space for sports activities. Among them, it offers a large area for sports games, including a soccer field, a swimming pool, and a padel court. Additionally, it has a spacious gym equipped with the latest machines to keep your body in shape.",
            ubicacion: "UBICATION",
            ...
            descripcion_monitores: "The Jelzi Sports Center has trained staff to supervise the various activities offered. These coaches are responsible for ensuring that all equipment functions correctly and safely, as well as helping ensure that exercises are performed properly to prevent injuries.",
            gimnasio: "GYM",
            ...
            padel_opcion: "Padel",
            seleccion_nivel: "Which is your level?",
